...
List<Post> posts = [
  Post(
    ...
    datePost: "Dec 1",
    timeReading: 6,
    tags: ["Rock & Roll", "Heavy metal", "Music", "Band"],
    isFavorite: false,
    content:
  ...
  Post(
    ...
    datePost: "Dec 2",
    timeReading: 6,
    tags: ["Rock & Roll", "Heavy metal", "Music", "Band", "Tutor", "Class"],
    isFavorite: false,
    content:
  ...
  Post(
    ...
    datePost: "Nov 30",
    timeReading: 6,
    tags: ["Programming", "Blog", "Flutter", "Hugo", "Dart", "Golang"],
    isFavorite: false,
    content:
  ...
  Post(
    ...
    datePost: "Dec 4",
    timeReading: 6,
    tags: ["Game", "Blockchain", "NFT", "Dodoland"],
    isFavorite: false,
    content:
